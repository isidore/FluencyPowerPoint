...
{
    public class PropertyBasedTestingTraining
    {
        public static void Create()
        {
            ...
            pptPresentation.SaveAs(@"c:\temp\PropertyBasedTests.pptx", PpSaveAsFileType.ppSaveAsDefault,
                MsoTriState.msoTrue);
        ...
        {
            var text = File.ReadAllText(PathUtilities.GetAdjacentFile("PropertyTest.trainingset.txt"));
    ...
    public class UnitTestStory
    {
        public readonly string story;
        public readonly string type;

        public UnitTestStory(string story, string type)
        {
            this.story = story;
            this.type = type;
        }
